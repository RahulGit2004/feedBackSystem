...
public class UI {
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            System.out.println("10. List of Feedbacks");
            System.out.println("11. Feedback List by Batch");
            System.out.println("12. Individual Feedback for Admin");
            ...
            switch (choice) {
                ...
                case 4:
                    // adding batch list when assign students
                    ...
                    System.out.println(userController.assignBatch(batchNameForAssign, studentPhone, adminPhoneForAssign));
                    break;
                ...
                case 11:
                    ...
                    System.out.println(userController.feedbackByBatch(adminPhoneForFeedbackByBatch, batchNameForFeedbackByBatchToAdmin));
                    break;
